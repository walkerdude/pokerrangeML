#!/usr/bin/env python3
"""
Create a simple, working model that definitely responds to different inputs
"""
...
def create_simple_working_model():
    ...
    # Generate a smaller but diverse dataset
    ...
    # Prepare features
    X, y = engineer.prepare_features(df_engineered, fit_scaler=True)  # Fit scaler during training
    ...
    # Train a very simple RandomForest
    ...
    joblib.dump(model_data, 'poker_range_classifier_simple.pkl')
    print(f"💾 Simple model saved as 'poker_range_classifier_simple.pkl'")
...
def test_responsiveness(model, engineer, feature_names):
    ...
    for i, test_case in enumerate(test_cases):
        ...
        X_test, _ = engineer.prepare_features(df_engineered, fit_scaler=False)  # Use fitted scaler
